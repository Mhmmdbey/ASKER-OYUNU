...
public class er extends karakterler {
   ...
   public er(String kiyafet){
       setKiyafet(kiyafet);
       System.out.println("---Giyilen kiyafet: "+ getKiyafet());
   }
   
   public  void surun() {
       System.out.println("----Er surunmeye basladi!----\n");
   ...
   public  void oyuner() {
	   ...
	   int [][] zemin = new int [10][10];
	    ...
	    String cevap;
         ...
         System.out.println("Her Dogru Hamle Icin 1 Puan Kazanacaksiniz!!");
