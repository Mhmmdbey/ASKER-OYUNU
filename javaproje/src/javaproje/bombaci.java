...
public class bombaci extends karakterler{
    String silah = " Bomba";
    int puan = 4;
    ...
    public bombaci(){
        System.out.println("--Silah turu:"+silah);

    }
    public bombaci(String kiyafet){
        setKiyafet(kiyafet);
        System.out.println("---Giyilen kiyafet: "+ getKiyafet());
    }


    public static void hazirlan(){
        System.out.println("----Bombaci bombalari hazirliyor!----\n");
    }
public void bombacioyun() {
	 ...
	 try (Scanner klavye = new Scanner(System.in)) {
		   ...
		   int [][] zemin = new int [10][10];
		    ...
		    String cevap;
	         ...
	         System.out.println("Her Dogru Hamle Icin 4 Puan Kazanacaksiniz!!");
