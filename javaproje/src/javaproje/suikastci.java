...
public class suikastci extends karakterler {
    ...
    public suikastci(String kiyafet){
       setKiyafet(kiyafet);
        System.out.println("---Giyilen kiyafet: "+ getKiyafet());
    }
    

    public static void bicagiBile() {
        System.out.println("----Suikastci bicagini biliyor----\n");
    	  ...
    	  try (Scanner klavye = new Scanner(System.in)) {
    		   ...
    		   int [][] zemin = new int [10][10];
    		    ...
    		    String cevap;
    	         ...
    	         System.out.println("Her Dogru Hamle Icin 2 Puan Kazanacaksiniz!!");
