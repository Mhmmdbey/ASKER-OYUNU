...
public class yuzbasi extends karakterler {
    String silah = "M4A-1";
    int puan = 5;
    ...
    public yuzbasi(String kiyafet){
        setKiyafet(kiyafet);
        System.out.println("---Giyilen kiyafet: "+ getKiyafet());
    }

    public static void cepheyeGit(){
        System.out.println("----Yuzbasi cepheye kosuyor!----\n");
    }
    
    public void yuzbasioyun() {
    	 ...
    	 try (Scanner klavye = new Scanner(System.in)) {
  		   ...
  		   int [][] zemin = new int [10][10];
  		    ...
  		    String cevap;
  	         ...
  	         System.out.println("Her Dogru Hamle Icin 5 Puan Kazanacaksiniz!!");
